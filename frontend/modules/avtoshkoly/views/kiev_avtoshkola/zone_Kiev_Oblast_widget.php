...
<div id="myBtnContainer">
    <button class="btn btn-default" onclick="filterSelection('all')"> Все города</button>
    <button class="btn btn-default" onclick="filterSelection('vyshgorod')">Вышгород</button>
